 ...
 * generated in the com.duongpt.javaeewebservice package. 
...
public class ObjectFactory {
    ...
    private final static QName _Sum_QNAME = new QName("http://javaeewebservice.duongpt.com/", "sum");
    private final static QName _SubtractResponse_QNAME = new QName("http://javaeewebservice.duongpt.com/", "subtractResponse");
    private final static QName _Subtract_QNAME = new QName("http://javaeewebservice.duongpt.com/", "subtract");
    private final static QName _SumResponse_QNAME = new QName("http://javaeewebservice.duongpt.com/", "sumResponse");

    /**
     * Create a new ObjectFactory that can be used to create new instances of schema derived classes for package: com.duongpt.javaeewebservice
     * 
     */
     ...
     * 
     */
    @XmlElementDecl(namespace = "http://javaeewebservice.duongpt.com/", name = "sum")
     ...
     * 
     */
    @XmlElementDecl(namespace = "http://javaeewebservice.duongpt.com/", name = "subtractResponse")
     ...
     * 
     */
    @XmlElementDecl(namespace = "http://javaeewebservice.duongpt.com/", name = "subtract")
     ...
     * 
     */
    @XmlElementDecl(namespace = "http://javaeewebservice.duongpt.com/", name = "sumResponse")
