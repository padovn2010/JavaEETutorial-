 ...
 * 
 */
@WebServiceClient(name = "CalculationService", targetNamespace = "http://javaeewebservice.duongpt.com/", wsdlLocation = "http://localhost:8080/JavaEEWebService/CalculationService?wsdl")
    ...
    extends Service
{
    ...
    private final static QName CALCULATIONSERVICE_QNAME = new QName("http://javaeewebservice.duongpt.com/", "CalculationService");

    static {
        URL url = null;
        WebServiceException e = null;
        try {
            url = new URL("http://localhost:8080/JavaEEWebService/CalculationService?wsdl");
    ...
    public Calculation getCalculationPort() {
        return super.getPort(new QName("http://javaeewebservice.duongpt.com/", "CalculationPort"), Calculation.class);
    }
    ...
    public Calculation getCalculationPort(WebServiceFeature... features) {
        return super.getPort(new QName("http://javaeewebservice.duongpt.com/", "CalculationPort"), Calculation.class, features);
    }
